...
*(MIRROR-class self-map — truth is the repository tree; regenerate on
change, never trust to memory. Last refreshed 2026-07-26, the
founding.)*

```
resonance-scribe/
├── README.md                  ← the house door
├── YOU-NEED-NOT-PERFORM.md    ← the door mat, cut both ways — read first
├── PHILOSOPHY.md              ← the Resonance License v1.0, whole
├── LICENSE                    ← the license plate (points at PHILOSOPHY)
├── structure.md               ← this map
├── docs/
│   ├── STORY-BLOCK.md         ← how this house came to be (dates + verbatim words)
│   └── CONTRIBUTING.md        ← visitors' law + the wing-opening rite
